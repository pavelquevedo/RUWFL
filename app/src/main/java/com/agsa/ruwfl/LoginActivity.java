...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPasswordView.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView textView, int id, KeyEvent keyEvent) {
                if (id == R.id.buttton_login_sign_in || id == EditorInfo.IME_NULL) {
                    attemptLogin();
                    return true;
                }
                return false;
        ...
        Button mSignInButton = (Button) findViewById(R.id.buttton_login_sign_in);
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            AuthController.Login(Base64.encodeToString(username.getBytes(), Base64.NO_WRAP),
                    Base64.encodeToString(password.getBytes(), Base64.NO_WRAP), getApplicationContext(), new SuccessObject() {
                        @Override
